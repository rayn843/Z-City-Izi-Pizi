...
DEFENSE_EndStatsPanel = nil

function RemoveEndDeFfRoundStatsPanel()
    if IsValid(DEFENSE_EndStatsPanel) then
        DEFENSE_EndStatsPanel:Remove()
        DEFENSE_EndStatsPanel = nil
    end
end
...
local function CreateEndRoundStatsPanel()
    ...
    DEFENSE_EndStatsPanel = vgui.Create("DPanel")
    DEFENSE_EndStatsPanel:SetPos(posX, posY)
    DEFENSE_EndStatsPanel:SetSize(topW, topH + medalH + padding)
    DEFENSE_EndStatsPanel:MakePopup()
    DEFENSE_EndStatsPanel:SetKeyboardInputEnabled(false)
    DEFENSE_EndStatsPanel:SetMouseInputEnabled(false)

    DEFENSE_EndStatsPanel.Paint = function(self, pw, ph) end

    local pnl1 = vgui.Create("DPanel", DEFENSE_EndStatsPanel)
    pnl1:SetPos(0, 0)
    ...
    local pnl2 = vgui.Create("DPanel", DEFENSE_EndStatsPanel)
    ...
    DEFENSE_EndStatsPanel.statsLbl = statsLbl
    DEFENSE_EndStatsPanel.pnl2 = pnl2
