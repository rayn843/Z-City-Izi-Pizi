...
function MODE:AfterBaseInheritance()
	...
	-- Очищаем типы базового Homicide, чтобы они не попадали в Homicide2
	self.Types.wildwest = nil
	self.Types.gunfreezone = nil
	self.Types.standard = nil
	self.Types.soe = nil
	self.Types.suicidelunatic = nil -- Добавьте эту строку
end
...
function MODE:Intermission()
	...
	-- Если подрежим не выбран, равен базовому "hmcd", или попытался встать "homicide2" / "fear"
	if not CROUND or CROUND == "hmcd" or CROUND == "homicide2" or CROUND == "fear" then
