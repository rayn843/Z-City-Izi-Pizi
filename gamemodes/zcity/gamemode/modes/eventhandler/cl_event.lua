...
EVENT_EndStatsPanel = nil

function RemoveEndEVRoundStatsPanel()
    if IsValid(EVENT_EndStatsPanel) then
        EVENT_EndStatsPanel:Remove()
        EVENT_EndStatsPanel = nil
    end
end
...
local function CreateEndRoundStatsPanel()
    ...
    EVENT_EndStatsPanel = vgui.Create("DPanel")
    EVENT_EndStatsPanel:SetPos(posX, posY)
    EVENT_EndStatsPanel:SetSize(topW, topH + medalH + padding)
    EVENT_EndStatsPanel:MakePopup()
    EVENT_EndStatsPanel:SetKeyboardInputEnabled(false)
    EVENT_EndStatsPanel:SetMouseInputEnabled(false)

    EVENT_EndStatsPanel.Paint = function(self, pw, ph) end

    local pnl1 = vgui.Create("DPanel", EVENT_EndStatsPanel)
    pnl1:SetPos(0, 0)
    ...
    local pnl2 = vgui.Create("DPanel", EVENT_EndStatsPanel)
    ...
    EVENT_EndStatsPanel.statsLbl = statsLbl
    EVENT_EndStatsPanel.pnl2 = pnl2
