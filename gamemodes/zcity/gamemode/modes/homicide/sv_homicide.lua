...
MODE.LootTable = {
	{40, {
		...
		{0.2,"weapon_morphine"},
        {0.2,"weapon_pill_caffe"},
        {0.2,"weapon_pill_captopril"},
        {0.2,"weapon_pill_metoprolol"},
        {0.2,"weapon_pill_midodrine"},
        {0.2,"weapon_pill_nifedipine"},
        {0.2,"weapon_pill_nitroglycerin"},
        {0.2,"weapon_pill_salt"},
		{0.5,"weapon_naloxone"},
		{0.1,"weapon_fentanyl"},
...
MODE.Types.suicidelunatic = {
    ...
    Messages = {
        [3] = "Everyone died.",
        [1] = "The suicide bomber has killed everyone.",
        [0] = "The suicide bomber was",
    },
    Message = "The suicide bomber was",
    TraitorLoot = function(ply)
        ply:Give("weapon_sogknife")
        ply:Give("weapon_walkie_talkie")
        ply:Give("weapon_traitor_ied")
